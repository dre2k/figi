...
saveRDS(figi_gwas, glue("{output_dir}/FIGI_EpiData/FIGI_v3.0_GWAS.rds"), version = 2)
...
saveRDS(gxe, "~/data/FIGI_EpiData_rdata/FIGI_v2.3_results_exposure_main_effects.rds")
...
saveRDS(gxe_table1, "~/data/FIGI_EpiData_rdata/FIGI_v2.3_results_exposure_table1.rds")
...
saveRDS(gxe_ggplot, "~/data/FIGI_EpiData_rdata/FIGI_v2.3_results_exposure_ggplot.rds")
