...
load(glue("{output_dir}/FIGI_EpiData/FIGI_SampleFile_Summary_201014.RData"))
...
list_of_variables <- read.table(glue("{output_dir}/FIGI_samplefile_epi-201014/list_of_variables.txt"), stringsAsFactors = F) %>% 
...
save.image(glue("{output_dir}/FIGI_EpiData/FIGI_Genotype_Epi_201014.RData"))
