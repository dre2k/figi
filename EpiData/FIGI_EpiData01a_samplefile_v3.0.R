...
samplefile = read.table('Samplefile_HRC1.1_epi_v3-20200922_usc.txt', header=T, fileEncoding='latin1', stringsAsFactors= F, sep='\t', na.strings=c('',NA))
...
table(samplefile$gxe, samplefile$EUR_subset) # 99726 (additional cases compared to v2.4)
...
# new location below
save.image(glue("{output_dir}/FIGI_EpiData/FIGI_SampleFile_Summary_201014.RData"))
