...
gxe_ggplot <-  readRDS(paste0(output_dir, "/FIGI_v3.1_gxeset_analysis_data_ggplot.rds")) %>% 
  mutate(active_met_875 = as.factor(ifelse(is.na(methrswklns),NA,
                          ifelse(methrswklns<8.75, "No", "Yes"))), 
         active_met_875_count = fct_explicit_na(active_met_875, na_level = "NA"),
         active_met_875_ggplot = fct_relevel(active_met_875_count, "NA"))
...
gxe_table1 <- readRDS("/media/work/gwis_test/data/FIGI_v3.1_gxeset_analysis_data_table1.rds") %>% 
  mutate(sex = factor(sex, labels = c("Female", "Male")), 
         bmic3 = factor(bmic3, labels = c("Normal", "Obese", "Overweight")),
         active_met_875 = as.factor(ifelse(is.na(methrswklns),NA,
                          ifelse(methrswklns<8.75, "No", "Yes"))),
         active_met_875_table1 = factor(active_met_875, exclude = NA, levels = c("No", "Yes", "P-value")))
...
table_covariates = c("active_met_875", "age_ref_imp", "sex", "asp_ref", "heightcm", "bmi", "bmic3", "energytot", "energytot_imp", "famhx1", "educ", "smk_ever", "hrt_ref_pm2", "diab", "calcium_totqc2", "folate_totqc2", "fiberqc2", "redmeatqc2", "procmeatqc2", "fruitqc2", "vegetableqc2", "p_diet_std")
