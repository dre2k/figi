...
create_forest_plot(data_epi = input_data, exposure = 'vegetable5qcm_scaled', covariates = covariates_meta, hrc_version = hrc_version, path = glue("{path}/output/posthoc/"), strata = "all", forest_height = 15, forest_width = 9, categorical = F)
create_forest_plot(data_epi = input_data, exposure = 'vegetable5qcm_scaled', covariates = covariates_meta, hrc_version = hrc_version, path = glue("{path}/output/posthoc/"), strata = "proximal", forest_height = 13, forest_width = 9, categorical = F)
create_forest_plot(data_epi = input_data, exposure = 'vegetable5qcm_scaled', covariates = covariates_meta, hrc_version = hrc_version, path = glue("{path}/output/posthoc/"), strata = "distal", forest_height = 13, forest_width = 9, categorical = F)
create_forest_plot(data_epi = input_data, exposure = 'vegetable5qcm_scaled', covariates = covariates_meta, hrc_version = hrc_version, path = glue("{path}/output/posthoc/"), strata = "rectal", forest_height = 13, forest_width = 9, categorical = F)
create_forest_plot(data_epi = input_data, exposure = 'vegetable5qcm_scaled', covariates = covariates_meta, hrc_version = hrc_version, path = glue("{path}/output/posthoc/"), strata = "female", forest_height = 13, forest_width = 9, categorical = F)
create_forest_plot(data_epi = input_data, exposure = 'vegetable5qcm_scaled', covariates = covariates_meta, hrc_version = hrc_version, path = glue("{path}/output/posthoc/"), strata = "male", forest_height = 13, forest_width = 9, categorical = F)
