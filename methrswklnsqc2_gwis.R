...
input_data <- readRDS(glue("/media/work/gwis_test/data/FIGI_{hrc_version}_gxeset_analysis_data_glm.rds")) %>% 
  ...
  mutate(methrswklnsqc2 = as.numeric(methrswklnsqc2))
# you need to incorporate methrswklnsqc2 into the other datasets you create for main effects summary tables etc
