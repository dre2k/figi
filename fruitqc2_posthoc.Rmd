...
res <- lapply(snps_out, function(snp) {
  assign("snp", snp, child_env)
  knitr::knit_child('posthoc_suggestive_gxe.Rmd', envir = child_env, quiet = TRUE)
  }
)
...
res <- lapply(snps_out, function(snp) {
  assign("snp", snp, child_env)
  knitr::knit_child('posthoc_locuszoom_only.Rmd', envir = child_env, quiet = TRUE)
  }
)
