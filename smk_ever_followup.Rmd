...
snps_out <- c("chr3_85461302_G_A", "chr4_147966066_G_A")
...
<!-- res <- lapply(snps_out, function(snp) { -->
<!--   assign("snp", snp, child_env) -->
<!--   knitr::knit_child('test_suggestive.Rmd', envir = child_env, quiet = TRUE) -->
<!--   } -->
<!-- ) -->
