...
write.csv(snps_3df, file = "~/Dropbox/vegetableqc2_chiSq3df_all_stats.csv", quote = F, row.names = F)



clumped <- fread("/media/work/gwis/clump_combined/FIGI_v2.3_gxeset_vegetableqc2_chiSq3df_no_gwas_ldclump.clumped")
test <- clumped %>% 
  filter(grepl(117809031, SP2))
